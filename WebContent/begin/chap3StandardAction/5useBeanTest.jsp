...
<body>
	...
	<!-- property java파일의 set뒤에 붙은 이름 첫글자는 소문자로 해서, name에 생성되어진 객체 이름 -->
	<jsp:setProperty property="name" name="memberdto" value="양정구"/>
	<jsp:setProperty property="gender" name="memberdto" value="M"/>
	<jsp:setProperty property="age" name="memberdto" value="29"/>
